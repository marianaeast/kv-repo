...
{
    TORCH_CHECK(map_size==64 || map_size==128 || map_size==256 || map_size==512 || map_size==1024, "unsupported chunk count");
    ...
    if(map_size == 64) {
        // this only needs to run once
        cudaFuncSetAttribute(gahter_copy_fixed_start_end<PTYPE, int64_t, 64>, cudaFuncAttributeMaxDynamicSharedMemorySize, maxSMBytes);

        gahter_copy_fixed_start_end<PTYPE, int64_t, 64><<<numBlocks, blockSize, maxSMBytes, at::cuda::getCurrentCUDAStream()>>>(
        values_ptr,
        v_cache_buffer_ptr,
        cpu_v_length, 
        gpu_v_length, 
        ...
        gahter_copy_fixed_start_end<PTYPE, int64_t, 256><<<numBlocks, blockSize, maxSMBytes, at::cuda::getCurrentCUDAStream()>>>(
        values_ptr,
        v_cache_buffer_ptr,
        cpu_v_length, 
        gpu_v_length, 
        ...
        gahter_copy_fixed_start_end<PTYPE, int64_t, 128><<<numBlocks, blockSize, maxSMBytes, at::cuda::getCurrentCUDAStream()>>>(
        values_ptr,
        v_cache_buffer_ptr,
        cpu_v_length, 
        gpu_v_length, 
        ...
        gahter_copy_fixed_start_end<PTYPE, int64_t, 512><<<numBlocks, blockSize, maxSMBytes, at::cuda::getCurrentCUDAStream()>>>(
        values_ptr,
        v_cache_buffer_ptr,
        cpu_v_length, 
        gpu_v_length, 
        ...
        gahter_copy_fixed_start_end<PTYPE, int64_t, 1024><<<numBlocks, blockSize, maxSMBytes, at::cuda::getCurrentCUDAStream()>>>(
        values_ptr,
        v_cache_buffer_ptr,
        cpu_v_length, 
        gpu_v_length, 
    ...
    int map_size = 256)
{
    ...
    if(map_size == 64) {
        // this only needs to run once
        cudaFuncSetAttribute(gather_copy_d2d<PTYPE, 64>, cudaFuncAttributeMaxDynamicSharedMemorySize, maxSMBytes);

        gather_copy_d2d<PTYPE, 64><<<numBlocks, blockSize, maxSMBytes, at::cuda::getCurrentCUDAStream()>>>(
        keys_ptr, 
        nullptr,
        gpu_v_length, 
        gpu_v_offset,
        ...
        gather_copy_d2d<PTYPE, 256><<<numBlocks, blockSize, maxSMBytes, at::cuda::getCurrentCUDAStream()>>>(
        keys_ptr, 
        nullptr,
        gpu_v_length, 
        gpu_v_offset,
        ...
        gather_copy_d2d<PTYPE, 128><<<numBlocks, blockSize, maxSMBytes, at::cuda::getCurrentCUDAStream()>>>(
        keys_ptr, 
        nullptr,
        gpu_v_length, 
        gpu_v_offset,
        ...
        gather_copy_d2d<PTYPE, 512><<<numBlocks, blockSize, maxSMBytes, at::cuda::getCurrentCUDAStream()>>>(
        keys_ptr, 
        nullptr,
        gpu_v_length, 
        gpu_v_offset,
        ...
        gather_copy_d2d<PTYPE, 1024><<<numBlocks, blockSize, maxSMBytes, at::cuda::getCurrentCUDAStream()>>>(
        keys_ptr, 
        nullptr,
        gpu_v_length, 
        gpu_v_offset,
    ...
    int map_size = 256)
{
    ...
    if(map_size == 64) {
        reorder_keys_and_mixed_offsets<int64_t, 64, 1024><<<numBlocks, blockSize, 0, at::cuda::getCurrentCUDAStream()>>>(
        cached_pos /*in*/, 
        cur_pos, 
        cached_pos /*out*/, 
        offsets_ptr, 
        ...
        reorder_keys_and_mixed_offsets<int64_t, 256, 1024><<<numBlocks, blockSize, 0, at::cuda::getCurrentCUDAStream()>>>(
        cached_pos /*in*/, 
        cur_pos, 
        cached_pos /*out*/, 
        offsets_ptr, 
        ...
        reorder_keys_and_mixed_offsets<int64_t, 128, 1024><<<numBlocks, blockSize, 0, at::cuda::getCurrentCUDAStream()>>>(
        cached_pos /*in*/, 
        cur_pos, 
        cached_pos /*out*/, 
        offsets_ptr, 
        ...
        reorder_keys_and_mixed_offsets<int64_t, 512, 2048><<<numBlocks, blockSize, 0, at::cuda::getCurrentCUDAStream()>>>(
        cached_pos /*in*/, 
        cur_pos, 
        cached_pos /*out*/, 
        offsets_ptr, 
        ...
        reorder_keys_and_mixed_offsets<int64_t, 1024, 4096><<<numBlocks, blockSize, 0, at::cuda::getCurrentCUDAStream()>>>(
        cached_pos /*in*/, 
        cur_pos, 
        cached_pos /*out*/, 
        offsets_ptr, 
    ...
    int batch_size, int heads, int cpu_v_length, int gpu_v_length, int gpu_v_offset, int gpu_v_stride, int map_size = 256) // input, torch stream
{
    ...
    if(map_size == 64) {
        // this only needs to run once
        cudaFuncSetAttribute(gather_copy_var_midpoint_BP<PTYPE, 64>, cudaFuncAttributeMaxDynamicSharedMemorySize, maxSMBytes);

        gather_copy_var_midpoint_BP<PTYPE, 64><<<numBlocks, blockSize, maxSMBytes, stream>>>(
            values_ptr, 
            temp_ptr, 
            v_cache_buffer_ptr, 
            cpu_v_length, 
